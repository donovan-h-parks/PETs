...
void CompatibilityGraph::build(const std::vector<SplitSystem*>& splitSystems, double bootstrapThreshold)
{
	// initialize matrices
...
CompatibilityGraph::PairInfo CompatibilityGraph::isCompatible(const SplitSystem* const ss1, const SplitSystem* const ss2, double bootstrapThreshold)
{
	...
	// determine splits is each system above bootstrap threshold
...
void CompatibilityGraph::cluster()
{
	m_clusters.clear();
